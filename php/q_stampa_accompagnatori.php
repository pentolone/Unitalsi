...
<html>
<head>
  <title>Stampa accompagnatori viaggio/pellegrinaggio</title>
...
/****************************************************************************************************
*
*  Stampa l'elenco degli accompagnatori/accompagnati
*
*  @file q_stampa_accompagnatoriphp
*  @abstract Stampa l'elenco degli accompagnatori/accompagnati
*  @author Luca Romano
*  @version 1.0
*  @time 2017-08-02
...
$redirect="../php/q_stampa_accompagnatori.php";
$print_target="../php/stampa_accompagnatori.php";
$titolo='Sconosciuto';
...
$sqlselect_gruppo .= " WHERE id_sottosezione = " . $sqlid_sottosezione .
                                   " ORDER BY 2";
$titolo = 'Stampa accompagnatori viaggio/pellegrinaggio';
