...
<html>
<head>
  <title>Gestione titolo di studio</title>
...
/****************************************************************************************************
*
*  Gestione dell'anagrafica titolo di studio
*
*  @file gestione_titolo_studio.php
*  @abstract Gestisce la descrizione del titolo di studio
*  @author Luca Romano
*  @version 1.0
*  @time 2017-02-13
...
$table_name="titolo_studio";
$redirect="../php/gestione_titolo_studio.php";
...
$sqlselect_titolo_studio = "SELECT id,  descrizione
                                             FROM   titolo_studio
                                             ORDER BY 2";
...
// verifica autorizzazioni  
  ...
  echo "<table>";
  echo "<tr>";
  echo "<td colspan='2' class='titolo'>Gestione Anagrafica titolo di studio</td>";
  echo "</tr>";

// Campo per la ricerca del dato
  echo "<form name='searchTxt' action='" . $redirect . "' method='POST'>";
  echo "<tr>";
  echo "<td><p class='search'>Seleziona titolo di studio</p></td>";
  echo "<td><select class='search' name='searchTxt'  onChange='this.form.submit();'>";
  ...
  echo "<tr>";
  echo "<td><p class='required'>Descrizione titolo di studio</p></td>";
