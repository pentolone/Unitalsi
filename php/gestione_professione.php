...
<html>
<head>
  <title>Anagrafica professione</title>
...
/****************************************************************************************************
*
*  Gestione dell'anagrafica professione
*
*  @file gestione_professione.php
*  @abstract Gestisce la descrizione della professione
*  @author Luca Romano
*  @version 1.0
*  @time 2017-01-26
...
$table_name="professione";
$redirect="../php/gestione_professione.php";
...
$sqlselect_professione = "SELECT id,  descrizione
                                           FROM   professione
                                           ORDER BY 2";
...
$conn = DB_connect();
  ...
  echo "<table>";
  echo "<tr>";
  echo "<td colspan='2' class='titolo'>Gestione Anagrafica professione</td>";
  echo "</tr>";

// Campo per la ricerca del dato
  echo "<form name='searchTxt' action='" . $redirect . "' method='POST'>";
  echo "<tr>";
  echo "<td><p class='search'>Seleziona professione</td></p></td>";
  ...
  echo "<tr>";
  echo "<td><p class='required'>Descrizione professione</td></p></td>";
