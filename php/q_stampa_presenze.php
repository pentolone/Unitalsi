...
<html>
<head>
  <title>Stampa foglio presenze</title>
...
/****************************************************************************************************
*
*  Stampa il foglio presenze per il Pellegrinaggio selezionato
*
*  @file q_stampa_presenze.php
*  @abstract Stampa il foglio presenze
*  @author Luca Romano
*  @version 1.0
*  @time 2017-10-02
...
$redirect="../php/q_stampa_presenze.php";
$print_target="../php/stampa_presenze.php";
$titolo='Sconosciuto';
...
$sqlExec .= " GROUP BY 2,3,4,5 ORDER BY 6, 4 DESC";
...
disegna_menu();
  ...
  echo "<td><p><select class='required' name='id_prn' required>" ;
