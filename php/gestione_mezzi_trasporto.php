...
<html>
<head>
  <title>Gestione mezzi di trasporto</title>
...
/****************************************************************************************************
*
*  Gestione della descrizione dei mezzi di trasporto
*
*  @file gestione_mezzi_trasporto.php
*  @abstract Gestisce la descrizione dei mezzi di trasporot
*  @author Luca Romano
*  @version 1.0
*  @time 2017-02-13
...
$table_name="mezzi_trasporto";
$redirect="../php/gestione_mezzi_trasporto.php";
...
$conn = DB_connect();
  ...
  echo "<table>";
  echo "<tr>";
  echo "<td colspan='2' class='titolo'>Gestione Anagrafica mezzi di trasporto</td>";
  echo "</tr>";

// Campo per la ricerca della descrizione
  echo "<form name='searchTxt' action='" . $redirect . "' method='POST'>";
  echo "<tr>";
  echo "<td><p class='search'>Seleziona Mezzo di trasporto</td></p></td>";
  ...
  echo "<tr>";
  echo "<td><p class='required'>Descrizione mezzo di trasporto</td></p></td>";
