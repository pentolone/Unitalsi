...
<html>
<head>
  <title>Gestione tipo di pagamento</title>
...
/****************************************************************************************************
*
*  Gestione della tipologia del pagamento
*
*  @file gestione_tipo_pagamento.php
*  @abstract Gestisce la descrizione della tipologia del pagamento
*  @author Luca Romano
*  @version 1.0
*  @time 2017-10-20
...
$redirect="../php/gestione_tipo_pagamento.php";
...
$sqlselect_tipo_pagamento = "SELECT id,  descrizione
                                                FROM   tipo_pagamento
                                                ORDER BY 2";
...
// verifica autorizzazioni  
  ...
  echo "<table>";
  echo "<tr>";
  echo "<td colspan='2' class='titolo'>Gestione Tipo pagamento</td>";
  echo "</tr>";

// Campo per la ricerca del dato
  echo "<form name='searchTxt' action='" . $redirect . "' method='POST'>";
  echo "<tr>";
  echo "<td><p class='search'>Seleziona Tipo pagamento</p></td>";
  echo "<td><select class='search' name='id-hidden' onChange='this.form.submit();'/>";
  $result = $conn->query($sqlselect_tipo_pagamento);
  ...
  echo "<tr>";
  echo "<td><p class='required'>Descrizione tipo pagamento</p></td>";
