...
<html>
<head>
  <title>Gestione tipologia di personale</title>
...
/****************************************************************************************************
*
*  Gestione della tipologia del personale
*
*  @file gestione_tipo_personale.php
*  @abstract Gestisce la descrizione della tipologia del personale
*  @author Luca Romano
*  @version 1.0
*  @time 2017-01-26
...
$index=0;
$update = false;
$table_name="tipo_personale";
$redirect="../php/gestione_tipo_personale.php";
...
$sqlselect_tipo_personale = "SELECT id,  descrizione
                                                FROM   tipo_personale
                                                ORDER BY 2";
...
// verifica autorizzazioni  
  ...
  echo "<table>";
  echo "<tr>";
  echo "<td colspan='2' class='titolo'>Gestione Tipologia personale</td>";
  echo "</tr>";

// Campo per la ricerca del dato
  echo "<form name='searchTxt' action='" . $redirect . "' method='POST'>";
  echo "<tr>";
  echo "<td><p class='search'>Seleziona Tipologia personale</p></td>";
  echo "<td><select class='search' name='id-hidden' onChange='this.form.submit();'/>";
  $result = $conn->query($sqlselect_tipo_personale);
  ...
  echo "<tr>";
  echo "<td><p class='required'>Descrizione tipologia personale</p></td>";
