...
/****************************************************************************************************
*
*  Gestione della descrizione delle disabilita'
*
*  @file gestione_disabilita.php
*  @abstract Gestisce la descrizione della disabilita
*  @author Luca Romano
*  @version 1.0
*  @time 2017-02-13
...
$table_name="disabilita";
$redirect="../php/gestione_disabilita.php";
...
$sqlselect_disabilita = "SELECT id,  descrizione
                                       FROM   disabilita
                                       ORDER BY 2";
...
$conn = DB_connect();
  ...
  echo "<table>";
  echo "<tr>";
  echo "<td colspan='2' class='titolo'>Gestione Anagrafica disabilit&agrave;</td>";
  echo "</tr>";

// Campo per la ricerca della disabilita'
  echo "<tr>";
  echo "<td><p class='search'>Seleziona Disabilit&agrave</td></p></td>";
  ...
  $result = $conn->query($sqlselect_disabilita);
  ...
  echo "<tr>";
  echo "<td><p class='required'>Descrizione disabili&agrave;</td></p></td>";
