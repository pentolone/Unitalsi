     ...
     echo "</tr>";
      ...
      $sql= "SELECT id,
       ...
       while($row = $result->fetch_assoc()) {
        	        ...
        	        echo "<tr>";
        	        echo "<td><p class='required'><a href='" . $downloadPath . "accompagnatori/" . $row["filename"] . "'>" . $row["filename"] . "</a></p></td>";
        	        echo "<tr>";
        	        $index++;
      ...
      $sql= "SELECT id,
       ...
       while($row = $result->fetch_assoc()) {
        	        ...
        	        echo "<tr>";
        	        echo "<td><p class='required'><a href='" . $downloadPath  . "accompagnati/". $row["filename"] . "'>" . $row["filename"] . "</a></p></td>";
        	        echo "<tr>";
        	        $index++;
