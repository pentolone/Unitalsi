...
CFisc.calcola_codice=function(nome,cognome,sesso,giorno,mese,anno,codice_catastale)
{
  var codice=
...
function calcola_codice_fiscale(form)
{
	var err_msg = 'Dati insufficienti per il calcolo automatico del codice fiscale\n\nRichiestI:\n- Cognome\n- Nome\n- Sesso\n- Luogo di nascita\n- Data di nascita';
	if(form.nome.value == '' ||
	   form.cognome.value == '' ||
	   form.data_nascita.value == '' ||
	   form.sesso.value == '' ||
	   form.codice_catastale.value == '') // Dati insufficienti per il calcolo
	   {
//	   	alert(form.nome.value);
//	   	alert(form.cognome.value);
//	   	alert(form.data_nascita.value);
//	   	alert(form.codice_catastale.value);
	     alert(err_msg);
	     return(false);
      }	  
//      alert('Tutto a postooooo'); 	
	//alert(form.codice_catastale.value);
  var data= form.data_nascita.value;
  ...
  var codice=CFisc.calcola_codice(
    ...
    form.codice_catastale.value
    )
	//alert(codice);
   form.cf.value=codice;
}
